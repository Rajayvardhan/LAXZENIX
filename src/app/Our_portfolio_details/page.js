        ...
        <>
            <div className="offcanvas-panel">
                ...
                <div className="offcanvas-panel-inner">
                    ...
                    <a href="project-details.html#" className="panel-close">
                                        ...
                                        <li className="menu-item has-children">
                                            ...
                                            <ul className="sub-menu">
                                                <li className="has-children">
                                                    <a href="project-details.html#">Multipage</a>
                                                    <ul className="sub-menu">
                                                        <li>
                                                ...
                                                <li className="has-children">
                                                    <a href="project-details.html#">Onepage</a>
                                                    <ul className="sub-menu">
                                                        <li>
                            ...
                            <div className="text">
                                    ...
                                    <div className="col-lg-8">
                                        <div className="content">
                                            ...
                                            <p>
                                                ...
                                                quasi architeto beatae vitae dicta sunt explicabo. Nemo
                                                enim ipsam voluptatem quia voluptas sit asperna turaut
                                                odit aut fugit sed quia consequntur magni dolore eosqui
                                                ratione voluptatem seque nesciunt. Neque porro quisquam
                                        ...
                                        <div className="content">
                                            ...
                                            <p>
                                                ...
                                                porroses quisquam est, qui dolorem ipsum quia dolor sit
                                                amet, consectetur, adipisci velit, sed quia non numquam
                                                eius modi tempora incidunt ut labore dolore magnam
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="row">
                                    <div className="col-lg-12">
                                        <div className="content">
                                            <img
                                                src="assets/images/portfolio/single-img-1.jpg"
                                                alt=""
                                            />
                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-5">
                                    <div className="post-nav-item prev-post">
                                        ...
                                        <div className="text">
                                            <h4>
                                                <a href="project-details.html">Creative Web Design</a>
                                            </h4>
                                            <p>
                                                <a href="projects.html">Design</a>,
                                                <a href="project-details.html#">Agency</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
