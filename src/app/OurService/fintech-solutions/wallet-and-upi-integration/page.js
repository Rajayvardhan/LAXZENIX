                        ...
                        <div className="col-lg-6">
                            <div className="text-wrapper mb-50 wow fadeInRight">
                                <div className="section-title mb-15">
                                    <span className="sub-title st-one">Wallet & UPI Integration?</span>
                                    <h2>Sevenunique, we provide advanced Wallet and UPI integration
                                    </h2>
                                </div>

                                <h4>About Wallet and UPI Integration</h4>
