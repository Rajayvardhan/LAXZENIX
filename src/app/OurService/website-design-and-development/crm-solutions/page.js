...
const faqs = [
    {
        ...
        answer: "A CRM system helps businesses manage customer relationships, track leads, and improve sales processes.",
    },
    {
        question: "Can CRM be customized for my business?",
        answer: "Yes, we build fully customized CRM solutions based on your specific business needs.",
    },
    {
        question: "Will CRM integrate with my website or apps?",
        answer: "Yes, we provide seamless integration with websites, mobile apps, and third-party tools.",
    },
    {
        question: "Do you provide training and support?",
        answer: "Yes, we offer complete training and ongoing support for your CRM system.",
    },
];
    return (
        <>
...
<p>
    CRM (Customer Relationship Management) is a system that helps businesses
    manage customer interactions, track leads, and streamline sales processes.
    It centralizes all your customer data, making it easier to improve relationships
    and increase conversions.
</p>

<p>
    In today’s competitive business environment, companies across India—especially
    in growing markets like Jaipur—use CRM systems to automate workflows, improve
    customer engagement, and drive revenue growth. A powerful CRM solution ensures
...
/>
    ...
    title="Why"
    highlight="Choose Us"
   upperdescription="Driving business growth with smart CRM solutions"
description="We provide advanced CRM solutions that help businesses streamline operations, manage customer relationships, and boost sales performance. Our systems are designed for efficiency, scalability, and real-time insights."
points={[
    { text: "Custom CRM solutions tailored to your business needs" },
    { text: "Automation of sales, leads, and workflows", wide: true },
    { text: "Secure and centralized customer data management" },
    { text: "Seamless integration with existing systems" },
    { text: "Scalable and cost-effective CRM solutions", wide: true },
]}
/>
            {/* Tools We Use */}
